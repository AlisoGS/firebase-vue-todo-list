<template>
  <v-container fill-height fluid text-center>
        <v-container>
            ...
            <v-row class="elevaion-3 mx-auto">
                <v-col cols=auto>
                    <v-img max-height="150" max-width="250" src="@/assets/images/firebase_logo.png"></v-img>
                </v-col>
                <v-col><v-form>
        ...
        <v-dialog v-model="novaConta" persistent max-width=300>
            <v-card>
                <v-card-title>Conta não existente.</v-card-title>
                <v-card-text>A conta não foi localizada. Deseja criar uma nova conta com os dados informados?</v-card-text>
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="green darken-1" text @click="criarNovaConta">Ok</v-btn>
